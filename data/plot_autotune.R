...
plot_autotune <- function (inf, outf) {
...
g = ggplot(df, aes(x=filesystem, y=bw, fill=factor(mode))) +
...
g = g + scale_y_continuous(breaks=seq(0, 6000,1000))
